# Baby AI Graph Baseline — after_q1_visual_cooc

- **Timestamp**: 2026-05-07T15:15:58.546230+00:00
...
## 3. Power-law fit
- alpha (exponent): **1.138**
- R²: **0.725**
- → heavy-tailed but unstable mean (alpha=1.14 < 2)
...
- ⚠️  isolated nodes 48.9% — concept generation outpacing edge formation
- ✅ scale-free likely (R²=0.73, alpha=1.14)
