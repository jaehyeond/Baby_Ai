...
from .agent_executor import CoderAgentExecutor
...
def main(host: str, port: int):
    """Claude 기반 Coder Agent 서버를 시작합니다."""
    try:
        # 환경변수 검증
        Config.validate()
        ...
        agent_card = AgentCard(
            ...
            description="Claude 기반 Python 코드 생성 에이전트",
            ...
            skills=[
                AgentSkill(
                    ...
                    description="요청에 따라 Python 코드를 생성합니다",
                    tags=["python", "coding", "code-generation"],
                    examples=[
                        "피보나치 함수를 작성해줘",
                        "파일 읽기 코드 만들어줘",
                        "리스트 정렬하는 함수",
        ...
        logger.info(f"Coder Agent 서버 시작: http://{host}:{port}")
